    ...
    <div class="container-fluid bg-primary p-5 bg-hero mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                ...
                <a href="/~2013464/fitness/public/viewschedulesindex" class="btn btn-light py-md-3 px-md-5">Classes</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">{{ $class->time }}</h6>
                                <h5 class="text-uppercase text-primary">{{ $class->type }}</h5>
                                <p class="text-uppercase text-secondary mb-0">{{ $class->pname }}</p>
                            </div>
                        </div>
                        @endforeach
                        <!-- <div class="col-lg-3 col-md-4 col-sm-6">
